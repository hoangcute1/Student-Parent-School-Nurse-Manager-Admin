...
export function SearchResults({
  ...
  const getFilterDescription = () => {
    ...
    if (classFilter !== "all") {
      ...
      filters.push(
        `phòng ban: ${
          departmentLabels[classFilter as keyof typeof departmentLabels]
        }`
      );
    }
    ...
    if (healthFilter !== "all") {
      ...
      filters.push(
        `trạng thái: ${statusLabels[healthFilter as keyof typeof statusLabels]}`
      );
    }
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <p className="text-xs text-sky-500">
              trong tổng số {totalOriginal} nhân viên
            </p>
          </div>
        </div>
