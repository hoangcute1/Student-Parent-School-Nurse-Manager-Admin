      ...
      <form onSubmit={handleSubmit} className="space-y-6 px-6 pb-6 pt-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select
              ...
              value={form.type}
              onChange={handleChange}
              className="w-full border border-sky-300 rounded-lg p-3 bg-white focus:ring-2 focus:ring-sky-400 focus:border-sky-500 shadow-sm transition-all outline-none"
              required
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              className="w-full border border-sky-300 rounded-lg p-3 focus:ring-2 focus:ring-sky-400 focus:border-sky-500 shadow-sm min-h-[60px] transition-all outline-none"
            />
          </div>
          <div>
            <label
        ...
        <div className="flex items-center gap-4 mt-2">
          <input
            ...
            onChange={handleChange}
            className="h-5 w-5 text-sky-600 border-gray-300 rounded focus:ring-sky-400"
          />
          <label
