  ...
  return (
    <div className="grid gap-6">
      <div>
        ...
        <p className="text-gray-500">Xem tổng quan về các hoạt động y tế học đường</p>
      </div>
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">Hồ sơ sức khỏe</CardTitle>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card className="md:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Các hoạt động y tế sắp diễn ra tại trường</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Các thông báo gần đây từ nhà trường</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {[
