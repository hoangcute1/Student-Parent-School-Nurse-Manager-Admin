...
export default function Sidebar({ isOpen, setIsOpen }: SidebarProps) {
  ...
  return (
    <aside
      className={cn(
        "fixed left-0 top-0 z-40 h-screen w-64 transform border-r bg-background transition-all duration-200 ease-in-out bg-blue-50",
        ...
        <div className="mt-auto space-y-4">
          ...
          <nav className="space-y-1">
            <Link
              ...
              className="flex items-center gap-3 rounded-lg px-4 py-2 text-blue-700 transition-all hover:text-blue-900 hover:bg-blue-100"
            >
